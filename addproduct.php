...
if (isset($_POST['submit'])) {
    ...
    if (in_array($filecheck, $fileextstored)) {
        ...
        $q = "INSERT INTO `product`(`product_name`, `image`, `user_id`) VALUES ('$product_name','$destinationfile','$id')";
        // print_r($q);
        $query = mysqli_query($conn, $q);
       header("location:productlist.php"); header("location:productlist.php");
    }
}
?>
       ...
       <a href="productlist.php" style="float: right;"><i class="fa fa-list"></i></a> 
            ...
            <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        <input type="text" class="form-control" name="product_name" pattern="[a-zA-Z\s]+" id="product_name" placeholder="Enter Product Name" required>
                    </div>
                </div>
